...
// TODO: Find the default language
    ...
    function get_languages() {
        ...
        if (class_exists('SitePress')) {
            ...
            return $language_options;
        } else if (class_exists('WPGlobus')) {
            $ids = WPGlobus::Config()->enabled_languages;
            foreach ($ids as $id) {
                $language_options[$id] = WPGlobus::Config()->language_name[$id];
            }
        }
    ...
    static function is_multilanguage() {
        ...
        return apply_filters('newsletter_is_multilanguage', class_exists('SitePress') || function_exists('pll_default_language') || class_exists('TRP_Translate_Press') || class_exists('WPGlobus'));
    }
