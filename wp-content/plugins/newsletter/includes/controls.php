            ...
            <div class = "tnp-tabs">
                ...
                <?php foreach ($languages as $key => $value) { ?>
                    <div id="tabs-a-<?php echo $key ?>">
                        <?php $this->wp_editor($key . '_confirmation_text'); ?>
                    </div>
                <?php } ?>
            </div>
        <?php } else { ?>
...
';
    ...
    static function label($text, $url) {
        ...
        echo $text, '<a href="', $url, '" target="_blank" title="Click for help"><i class="fas fa-question-circle"></i></a>';
        //echo '<a href="', $url, '" target="_blank" title="Click for help">', $text, '</a>';
    }
