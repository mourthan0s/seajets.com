...
<div id="tnp-menu">
    <ul>
        ...
        <li><a href="#"><i class="fas fa-users"></i> <?php _e('Subscribers', 'newsletter') ?></a>
            <ul>
                <li>
                    <a href="?page=newsletter_users_index"><?php _e('Search And Edit', 'newsletter') ?></a>
                </li>
        ...
        <li><a href="#"><i class="fas fa-list"></i> <?php _e('List Building', 'newsletter') ?></a>
            <ul>
                ...
                <li>
                    ...
                    <a href="<?php echo $url ?>"><?php _e('Subscribe', 'newsletter') ?></a>
                </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    <a href="?page=newsletter_emails_index"><?php _e('Newsletters', 'newsletter') ?></a>
                </li>
        ...
        <?php if ($is_administrator) { ?>
            <li>
                <a href="#"><i class="fas fa-info"></i> <?php _e('System', 'newsletter') ?>
                    <?php if ($warning) { ?>
                ...
                <ul>
                    <li>
                        <a href="<?php echo admin_url('site-health.php') ?> "><i class="fas fa-file"></i> <?php _e('WP Site Health') ?></a>
                    </li>
                    <li>
                        <a href="?page=newsletter_system_delivery"><?php _e('Delivery Diagnostic', 'newsletter') ?></a>
                    </li>
                    <li>
                        <a href="?page=newsletter_system_scheduler"><?php _e('Scheduler', 'newsletter') ?></a>
                    </li>
                    <li>
                        <a href="?page=newsletter_system_status"><?php _e('Status', 'newsletter') ?></a>
                    </li>
